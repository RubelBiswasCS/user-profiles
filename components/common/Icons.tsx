export const Facebook = ({ className }: any) => (
	<svg
...
export const Twitter = ({ className }: any) => (
	<svg
		xmlns="http://www.w3.org/2000/svg"
		className={`h-3 w-3 ${ className }`}
		fill="currentColor"
...
export const Location = ({ className }: any) => (
	<svg 
		className={`h-3 w-3 ${ className }`}
		fill="#000000" 
		version="1.1" 
	...
	>
		...
		<g 
		id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> 
		<path 
